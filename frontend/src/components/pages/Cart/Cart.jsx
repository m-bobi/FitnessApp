...
const Cart = () => {
  ...
  const handleCheckout = async () => {
    const response = await api.post(`checkout/${cart[0].productId}`, {
      quantity: 1,
    });
                          ...
                          <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                            ...
                            <div className="flex items-center justify-between md:order-3 md:justify-end">
                              <div className="flex items-center">
                                <button
                                  onClick={() =>
                                    handleQuantityChange(p.productId, -1)
                                  }
                                  type="button"
                            ...
                            <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                              ...
                              <div className="flex items-center gap-4">
                                <button
                                  ...
                                  type="button"
                                  className="inline-flex items-center text-sm font-medium text-green-500 hover:text-gray-900 hover:underline dark:text-gray-400 dark:hover:text-white"
                                >
                                  Proceed to checkout
                                </button>
