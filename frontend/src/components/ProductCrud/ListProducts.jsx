...
const ListProducts = () => {
  ...
  const handleEditField = (field, value) => {
    ...
    if (
      ["productPrice", "productStock", "productRate"].includes(field) &&
      value < 0
    ) {
  ...
  const fetchProducts = async () => {
    try {
      const response = await api.get("api/Products/getAllofProducts");
                      ...
                      <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                          <img
                            ...
                            src={`/img/products/${p.productImage}`}
                          />
                        ...
                        <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                          {[...p.productName].map((letter, index) => (
                            <span
                              key={index}
                              style={{
                                fontWeight: searchQuery.includes(letter)
                                  ? "bold"
                                  : "normal",
                              }}
                            >
                ...
                <div key={field} className="relative">
                  ...
                  {field === "productCategory" ? (
                    ...
                    <input
                      ...
                      placeholder={editedProduct[field]}
                      onChange={(e) => handleEditField(field, e.target.value)}
                      className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      min={
                        [
