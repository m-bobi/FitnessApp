    ...
    useEffect(() => {
      ...
      const handleDelete = async (id) => {
        if (window.confirm("Are you sure you want to delete this user?")) {
          try {
            await axios.delete(
              `${config.apiBaseURL}api/Offers/deleteOffer/${id}`,
              {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
  ...
  return (
    ...
    <div className="w-full mb-1">
        <div className="mb-4">
            ...
            <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Offers</h1>
        </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        {
                            allOffers && allOffers.length > 0 ? (
                              ...
                              allOffers.map(o => (
                                ...
                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{o.offerDescription}</td>
                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">${o.offerPrice}</td>
                                ...
                                <td className="p-4 space-x-2 whitespace-nowrap">
                                    ...
                                    <button onClick={() => handleDelete(o.offerId)} data-modal-target="delete-user-modal" data-modal-toggle="delete-user-modal" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
