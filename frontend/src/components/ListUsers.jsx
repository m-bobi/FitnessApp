    ...
    useEffect(() => {
      ...
      const handleUpdate = async () => {
        try {
          ...
          await axios.put(
            `${config.apiBaseURL}api/User/updateUser/${selectedUser.id}`,
            userUpdateDto
          );
                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        {
                            ...
                            allUsers.map(user => (
                                ...
                                <td className="p-4 space-x-2 whitespace-nowrap">
                                    <button  onClick={() => handleEdit(user)} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
