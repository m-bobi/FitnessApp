...
{
    /// <inheritdoc />
    public partial class restartedOnce : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainerId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkoutId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    WorkoutType = table.Column<string>(type: "varchar(12)", maxLength: 12, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WorkoutStartTime = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WorkoutEndTime = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrainerClassId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerClasses", x => x.TrainerClassId);
                    table.ForeignKey(
                        name: "FK_TrainerClasses_AspNetUsers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainerClasses_Class_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "80c8b6b1-e2b6-45e8-b044-8f2178a90111", 0, "admin street", new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "e41cc222-137c-4c2c-ac0a-67d408e36f77", new DateTime(2024, 6, 8, 14, 57, 44, 960, DateTimeKind.Utc).AddTicks(540), "root@email.com", false, "Male", null, false, null, "Admin", "ROOT@EMAIL.COM", "ROOT@EMAIL.COM", "AQAAAAIAAYagAAAAECpsCTv8GLpNLdG1RFoIlPmJVz/uLH+A8TjJ8QXPEPA93sdPy1Vju6RF0AAnxkWOxw==", "044234234", false, "", 1, "6476d665-b303-4108-9caa-f989496ccb60", false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerClasses_ClassId",
                table: "TrainerClasses",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainerClasses_TrainerId",
                table: "TrainerClasses",
                column: "TrainerId");
